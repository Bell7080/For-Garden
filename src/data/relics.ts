...
export const RELICS: RelicDef[] = [
  ...
  },
  {
    ...
    // 동경의 1순위는 스쿼드가 아니라 **주인공**이다 — 시그널 아이를 올려다보는 것도 결국
    // "대장님 옆에서 더 쓸모 있어지려고"라는 이유라서, 두 마음의 순서를 문장에 못 박는다.
    squadNote: "쁘띠 로그의 막내 기록병. 자칭 이터널 최정예 탐험대의 발견을 전부 받아 적겠다며 깃펜을 놓지 않지만, 일지 절반은 주운 반짝이 목록이다. 무엇보다 대장님의 1호 팬을 자처해 일지 첫 장부터 그 이름이 적혀 있고, 부르는 목소리도 제일 크다.",
