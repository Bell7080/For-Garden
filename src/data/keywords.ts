...
export const KEYWORDS: readonly KeywordDef[] = [
  ...
  },
  {
    ...
    description: "기본 공격을 낼 때마다 적 주위에 얕은 물이 고인다. 아직 아무도 붙지 않은 적 주위가 먼저 젖으며, 이미 고인 판과 가까우면 새로 생기지 않고 그 판이 갱신된다. 잠긴 적은 이동 속도가 35% 느려지고 물 밖으로 나가면 곧바로 풀린다. 기본 공격 4회마다 적이 가장 많이 잠긴 여울로 순간이동해 그 자리를 터뜨리며, 그때 잠겨 있던 적은 40% 더 받는다. 터진 판은 마른다.",
  },
  {
