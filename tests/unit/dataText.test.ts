...
describe("덮어쓰기 표", () => {
  ...
  it("는 다 채운 언어에 구멍을 내지 않는다", () => {
    ...
    const COMPLETE = ["en", "ja", "zh-Hant", "zh-Hans", "th", "vi", "id", "es", "pt-BR", "de", "ru"];
...
const NOT_DISPLAYED: Readonly<Record<string, "all" | readonly string[]>> = {
  ...
  "../../src/data/raid.ts": ["하늘정원", "이끼연구소", "비올라", "주전자", "정오의표본", "먼지떨이", "잔불", "석영", "밀물", "난초", "재", "고사리", "달무리", "조약돌", "신호탑", "등불", "골수연구", "버드나무", "돌풍", "호박빛", "점판암", "양피지", "표류", "가마"],
};
