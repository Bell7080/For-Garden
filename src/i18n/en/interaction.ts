...
export const INTERACTION_EN = {
  ...
  "interaction.exchange.owned": "Specimens held  {owned}",
  "interaction.exchange.required": "Required  {amount}",
  "interaction.exchange.result": "Exchange result  Cheesecake {amount}",
