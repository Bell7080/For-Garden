...
new Phaser.Game({
  ...
  scene: [BootScene, TitleScene, OpeningScene, LobbyScene, SettingsScene, FriendsScene, MissionsScene, ShopScene, RelicsScene, LabScene, ExcavationScene, StageMapScene, PartyScene, BattleScene],
});
