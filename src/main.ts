...
import { BountyScene } from "./scenes/BountyScene";
...
const game = new Phaser.Game({
  ...
  scene: [BootScene, TitleScene, OpeningScene, LobbyScene, PvpPreviewScene, InteractionScene, ExpeditionScene, SortiePreviewScene, RaidScene, CakeOperationScene, BountyScene, SettingsScene, FriendsScene, ShopScene, PremiumScene, RelicsScene, LabScene, ArchaeologyScene, StageMapScene, StageStoryScene, PartyScene, BattleScene, EffectOverlayScene],
});
