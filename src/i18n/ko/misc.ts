...
export const MISC_KO = {
  ...
  "shop.haine.line1": "돌아왔네. 세어 볼 테니 증표는 이쪽에 올려 둬.",
  "shop.haine.line2": "물건은 여기 다 있어. 안 보이면 없는 거고, 없으면 다음에 들어와.",
  "shop.haine.line3": "증표는 쌓아 둬도 이자가 안 붙어. 쓸 거면 지금 써.",
  "shop.haine.line4": "그쪽 상자, 손대지 마. 아직 장부에 안 올렸어.",
  "shop.haine.line5": "다음에도 제 발로 와. 실려 오면 물건은 내가 대신 못 받아 주니까.",
  ...
  // 우편
  "mail.title": "우편함",
  "mail.claimAll": "첨부 보상 일괄 수령",
  "mail.state.expired": "만료",
  "mail.state.claimed": "수령 완료",
  "mail.state.notice": "안내",
  "mail.state.readClaimable": "읽음 · 수령 가능",
  "mail.state.newClaimable": "새 우편 · 수령 가능",
  "mail.statusLine": "{state}  ·  {expiry}",
  "mail.noExpiry": "기한 없음",
  "mail.expiresOn": "만료 {date}",
  ...
  "profile.changeModifier": "수식어 변경",
  "profile.favorite": "애착 렐릭",
  "profile.unset": "미지정",
  "profile.arenaTier": "결투장 티어",
  "profile.highestClear": "최대 클리어",
