...
export const SKILL_KO = {
  ...
  "skill.passive.summonCommander": "전투 시작 시 [[summon-kuro|쿠로]]와 [[summon-shiro|시로]]를 소환한다. 둘이 모두 살아 있는 동안 [[stealth|은신]]한다.{exposed}",
  ...
  "skill.clause.nape": "표적의 체력이 {percent}% 이하면 [[nape|목덜미]]를 문다",
  "skill.clause.napeAlways": "표적의 체력과 무관하게 [[nape|목덜미]]를 문다",
  "skill.clause.commandsPack": "살아 있는 [[summon-kuro|쿠로]]와 [[summon-shiro|시로]]가 그 표적에게 곧바로 궁극기를 쓴다",
