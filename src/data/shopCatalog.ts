...
const LEGACY_PRODUCTS: readonly ProductDefinition[] = [
  ...
  { id: "trade-weeds", storefront: "trade", category: "general", iconKey: "shop-product-supplies", name: "복원용 치즈케이크 묶음", description: "급여에 쓰는 치즈케이크 100개", acquisition: { kind: "currency", currency: "fossil", amount: 180 }, grants: [{ kind: "currency", currency: "cheesecake", amount: 100 }], defaultQuantity: 1, purchaseLimit: 3, refresh: "daily", visibleFrom: "2026-01-01T00:00:00Z", visibleUntil: "2030-01-01T00:00:00Z" },
  { id: "trade-dna", storefront: "trade", category: "enhancement", iconKey: "shop-product-enhancement", name: "공용 DNA 조각", description: "돌파 재료 5개", acquisition: { kind: "currency", currency: "cheesecake", amount: 80 }, grants: [{ kind: "currency", currency: "dnaFragments", amount: 5 }], defaultQuantity: 1, purchaseLimit: 2, refresh: "weekly", visibleFrom: "2026-01-01T00:00:00Z", visibleUntil: "2030-01-01T00:00:00Z" },
  // 룬 탭의 프로토타입 상품이며 완성 룬 발급 계약 전까지 룬 연구 재료를 지급한다.
  { id: "trade-rune-kit", storefront: "trade", category: "rune", iconKey: "shop-product-rune", name: "룬 각인 연구 묶음", description: "룬 연구용 DNA 조각 8개", acquisition: { kind: "currency", currency: "fossil", amount: 260 }, grants: [{ kind: "currency", currency: "dnaFragments", amount: 8 }], defaultQuantity: 1, purchaseLimit: 2, refresh: "weekly", visibleFrom: "2026-01-01T00:00:00Z", visibleUntil: "2030-01-01T00:00:00Z" },
