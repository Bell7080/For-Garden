 ...
 * 하단 조작 두 장.
 *
 * 출격이 주 행동이라 오른쪽에 크게 서고, 상점은 그 왼쪽에 한 뼘 작게 선다 — 로비의 출격과
 * 서브 콘텐츠가 크기로 위계를 가르는 것과 같은 규칙이다. 우하단은 공용 뒤로가기 자리라
 * 두 버튼 모두 그 위를 지나지 않는다.
 */
export const RAID_ACTIONS = {
  y: BASE_HEIGHT - 132,
  shop: { centerX: 306, width: 380, height: 108 },
