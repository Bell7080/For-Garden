/** 원정 기록 보상 팝업의 문구. */
export const EXPEDITION_REWARD_KO = {
  ...
  "expeditionReward.notEnough": "점수가 부족합니다. 최신 진행량을 확인해 주세요.",
  "expeditionReward.stageClosed": "주차가 변경되었거나 보상 단계가 종료되었습니다.",
  "expeditionReward.weekRolled": "주차가 변경되었습니다. 기록을 다시 확인해 주세요.",
} as const;
