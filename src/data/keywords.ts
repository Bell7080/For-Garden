...
export const KEYWORDS: readonly KeywordDef[] = [
  ...
  // 밴덜리즘도 쓰는 개체가 데이나 하나뿐이라 태그가 수치를 가진다. 둘째 개체가 이 규칙어를
  // 갖게 되면 출혈처럼 시간·비율을 본문으로 옮기고 태그는 무엇인지만 말하게 바꾼다.
  {
    id: "vandalism", term: "밴덜리즘", kind: "디버프",
    description: "한 겹마다 그 적의 공격력과 주문력이 5% 낮아진다. 최대 5겹까지 쌓이고 8초 동안 남으며, 다시 칠하면 유지 시간이 처음부터 다시 흐른다. 5겹째에 그 자리에서 터져 칠한 쪽 주문력의 130%에 해당하는 마법 피해를 주고 겹은 0으로 돌아간다.",
  },
