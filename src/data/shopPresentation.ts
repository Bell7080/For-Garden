 ...
 *
 * 토벌과 인양에서 돌아온 사람의 증표를 받는 자리이고, 그 일을 **즐긴다.** 장난꾸러기에
 * 속물이라 증표 소리부터 알아듣고, 묻기도 전에 계산서를 쓱 내민 뒤 손가락을 입에 대고
 * 히죽 웃는다. 깎아 달라는 말을 거절하지 않는 대신 다음에 두 배로 받아 가고, 주머니에
 * 남은 것까지 세어 두고서는 귀가 밝다고만 한다.
 *
