...
export const KEYWORDS: readonly KeywordDef[] = [
  ...
  // 약점 포착도 쓰는 개체가 슈테 하나뿐이라 태그가 수치를 가진다. 둘째 개체가 이 규칙어를
  // 갖게 되면 출혈처럼 수치를 본문으로 옮기고 태그는 무엇인지만 말하게 바꾼다.
  {
    id: "weakpoint", term: "약점 포착", kind: "디버프",
    description: "표식을 찍은 개체의 듀오가 그 적을 때리면 터져, 찍은 개체의 주문력의 120%에 해당하는 마법 피해를 주고 그 피해의 50%만큼 듀오가 체력을 회복한다. 터진 표식은 사라지며, 시간이 흘러 사라지지는 않는다.",
  },
  {
