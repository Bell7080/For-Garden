...
export const CURRENCY_GUIDE = {
  fossil: { key: "fossil", name: "화석", lore: "복원 가능한 생명의 흔적이 잠든 표본입니다.", sources: ["배치형 자원 발굴", "원정 노드·주간 기록", "무역 보급품·후원 패키지"], uses: ["연구소의 화석 연구", "무역의 치즈케이크 교환"], action: { kind: "scene", target: "lab", label: "연구소로 이동" } },
  ...
  gems: { key: "gems", name: "젬", lore: "도시의 연구 시설과 보급망이 인정하는 결정 화폐입니다.", sources: ["배치형 자원 발굴", "원정 노드·주간 기록", "연구 후원 일일 보너스"], uses: ["상점과 운영 상품 계약"], action: { kind: "popup", target: "trade", label: "무역소 열기" } },
  ...
  dnaFragments: { key: "dnaFragments", name: "DNA 조각", lore: "복원체의 잠재 구조를 다시 잇는 공용 유전 표본입니다.", sources: ["무역의 복원 재료 교환", "중복 복원 연구"], uses: ["렐릭 돌파 성장"], action: { kind: "popup", target: "trade", label: "무역소 열기" } },
  cheesecake: { key: "cheesecake", name: "치즈케이크", lore: "복원체와 신뢰를 쌓는 연구소의 특별 급여입니다.", sources: ["배치형 자원 발굴", "화석·호박석 연구 부산물", "원정·일일 광고 보상", "무역 교환"], uses: ["렐릭 급여 성장", "무역의 DNA 조각·보급품 교환"], action: { kind: "popup", target: "trade", label: "무역소 열기" } },
