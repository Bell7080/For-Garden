...
export const ITEMS = [
  ...
  { id: "refined-core", name: "정제된 고대 핵", description: "영웅 이상 등급의 특성을 확정으로 부여합니다.", category: "material", icon: { kind: "asset", key: "item-refined-core" }, maxStack: 999, useEffect: { kind: "none" } },
  { id: "restoration-crystal", name: "완전 복원 결정", description: "특성의 등급을 한 단계 확정으로 올립니다. 전설 특성에는 사용할 수 없습니다.", category: "material", icon: { kind: "asset", key: "item-restoration-crystal" }, maxStack: 999, useEffect: { kind: "none" } },
