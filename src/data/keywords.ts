...
export const KEYWORDS: readonly KeywordDef[] = [
  ...
  },
  {
    ...
    description: "기본 공격을 낸 자리에 얕은 물이 고인다. 판은 한 곳만 유지되며 공격할 때마다 자리와 시간이 갱신된다. 여울에 잠긴 적은 이동 속도가 35% 느려지고 받는 피해가 20% 증가하며, 물 밖으로 나가면 곧바로 풀린다. 여울에 잠긴 적을 때리면 연격이 확정으로 4회 적중한다.",
  },
  {
