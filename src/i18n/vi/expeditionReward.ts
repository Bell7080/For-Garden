...
export const EXPEDITION_REWARD_VI = {
  ...
  "expeditionReward.notEnough": "Không đủ điểm. Hãy kiểm tra tiến trình mới nhất.",
  "expeditionReward.stageClosed": "Tuần đã đổi hoặc mốc thưởng này đã đóng.",
  "expeditionReward.weekRolled": "Tuần đã đổi. Hãy xem lại kỷ lục.",
} as const;
