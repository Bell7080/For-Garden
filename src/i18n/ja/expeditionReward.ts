/** 원정 기록 보상 팝업의 일본어 표. */
export const EXPEDITION_REWARD_JA = {
  ...
  "expeditionReward.notEnough": "スコアが足りません。最新の進行量をご確認ください。",
  "expeditionReward.stageClosed": "週が変わったか、報酬段階が終了しました。",
  "expeditionReward.weekRolled": "週が変わりました。記録をもう一度ご確認ください。",
} as const;
