...
const BASELINES = {
  ...
  "1-1": { duration: [25, 31], hp: [0.82, 0.92] },
  "1-4": { duration: [28, 34], hp: [0.71, 0.81] },
  "1-5": { duration: [29, 35], hp: [0.8, 0.9] },
  "1-9": { duration: [29, 35], hp: [0.68, 0.78] },
  "1-10": { duration: [27, 33], hp: [0.64, 0.74] },
} as const;
