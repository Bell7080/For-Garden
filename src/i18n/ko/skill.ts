...
export const SKILL_KO = {
  ...
  // ── 마무리 한 방 ─────────────────────────────────────────────────────────
  "skill.finisher.bite": "[[nape|목덜미]]를 문다",
  "skill.finisher.always": "이어 표적의 체력과 무관하게 {bite}.",
  ...
  "skill.passive.summonCommander": "전투 시작 시 [[summon-kuro|쿠로]]와 [[summon-shiro|시로]]를 소환한다. 무리의 첫 표적은 두 늑대가 확인한 적 중 전투력이 가장 높은 적이다. 둘이 모두 살아 있는 동안 {guard}{exposed}{scent}",
  "skill.passive.summonCommander.guard": "[[stealth|은신]]한다.",
  "skill.passive.summonCommander.guardCrit": "[[stealth|은신]]하고 무리 전체의 치명타 확률이 {percent}% 오른다.",
  "skill.passive.summonCommander.exposed": " 한 마리라도 쓰러지면 은신이 풀려 다시 표적이 된다.",
  "skill.passive.summonCommander.scent": " 표적이 쓰러지거나 [[nape|목덜미]]를 물 때마다 [[bloodscent|피 냄새]]를 한 겹 얻는다.",
  ...
  "skill.sentence.dualStrike.alone": "두 늑대가 모두 쓰러져 있는 동안에는 대신 {physical}의 물리 피해와 {magical}의 마법 피해를 번갈아 준다.",
  "skill.sentence.packAssault": "적 한 명에게 살아 있는 늑대가 모두 [[charge|돌진]]해 각자 {percent}% 위력의 피해를 준다.",
  "skill.sentence.packAssault.resummon": "쓰러진 늑대는 부활 대기 시간이 {seconds}초 줄어, 그 자리에서 다시 서면 함께 돌진한다.",
  ...
  "skill.keyword.summon.description": "{owner}의 {stat}{stat!이} 모든 능력치를 정하는 근거리 소환수다. 스스로 표적을 고르고 제 게이지로 궁극기를 쓴다.{resummon}",
  ...
  "skill.keyword.bloodscent.description": "표적이 쓰러지거나 [[nape|목덜미]]를 물 때마다 한 겹 얻고 최대 {stacks}겹까지 쌓인다. 겹마다 일반 공격 피해가 {percent}% 커지고,{threshold} 전투가 끝나면 사라진다.",
