 ...
 */
const RELICS_WITH_ART: readonly string[] = ["anky", "rex", "spino", "luka", "dodo", "mette", "stella", "tia", "meron", "pachi", "maki", "keris", "delopi", "ella", "husk-raptor", "husk-shell", "husk-wing", "pontos"];
