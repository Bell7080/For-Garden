...
const game = new Phaser.Game({
  ...
  scene: [BootScene, TitleScene, OpeningScene, LobbyScene, ExpeditionScene, SettingsScene, FriendsScene, ShopScene, RelicsScene, LabScene, ArchaeologyScene, StageMapScene, PartyScene, BattleScene],
});
