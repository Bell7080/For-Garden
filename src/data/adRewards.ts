...
export type ExcavationAdEffect =
  ...
  | { readonly kind: "production_speed"; readonly multiplier: 2; readonly durationSeconds: number; readonly refresh: "replace_expiry" };
...
export const AD_REWARD_SLOTS = [
  ...
  // 같은 효과 재수령은 배율을 곱하지 않고 서버 시각부터 만료만 교체한다.
  { id: "excavation-speed", displayText: "생산 2배 · 60분", reward: { kind: "excavation_effect", effect: { kind: "production_speed", multiplier: 2, durationSeconds: 3_600, refresh: "replace_expiry" } }, dailyLimitUtc: 2, placement: "idle_excavation" },
