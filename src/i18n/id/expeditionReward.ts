...
export const EXPEDITION_REWARD_ID = {
  ...
  "expeditionReward.notEnough": "Skor tidak cukup. Periksa progres terbaru.",
  "expeditionReward.stageClosed": "Minggu telah berganti atau tahap hadiah ini sudah ditutup.",
  "expeditionReward.weekRolled": "Minggu telah berganti. Periksa rekor lagi.",
} as const;
