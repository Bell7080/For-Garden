...
export const MISC_JA = {
  ...
  "shop.haine.line1": "戻ったか。数えるから証票はそこに置いて。",
  "shop.haine.line2": "在庫は全部出してある。見当たらないならうちには無い。次を待ちな。",
  "shop.haine.line3": "証票は寝かせても利子はつかない。使うなら今だ。",
  "shop.haine.line4": "その箱には触るな。まだ帳簿に載せてない。",
  "shop.haine.line5": "次も自分の足で来い。担がれて来たら受け取りのサインはしてやれない。",
