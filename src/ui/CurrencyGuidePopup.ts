 ...
 */
const HERO = { y: -290, width: 660, height: 176, frameSize: 116 } as const;
...
export class CurrencyGuidePopup {
  ...
  private addHolding(body: Phaser.GameObjects.Container, key: WalletItemKey): void {
    ...
    body.add(this.scene.add.image(iconX, HERO.y, CURRENCY_ICON_BY_WALLET[key]).setDisplaySize(HERO.frameSize * ITEM_FRAME.icon, HERO.frameSize * ITEM_FRAME.icon));
