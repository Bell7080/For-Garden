...
export const ULTIMATE_PRESENTATIONS: Readonly<Record<string, UltimatePresentation>> = Object.freeze({
  ...
  luka: { ...DEFAULT_ULTIMATE_PRESENTATION, enterFrom: "right", artworkOrigin: { x: 620, y: 800 }, cutInHoldMs: 390, zoomScale: 1.18, zoomMs: 110 },
  dodo: { ...DEFAULT_ULTIMATE_PRESENTATION, artworkScale: 0.9, artworkOrigin: { x: 640, y: 790 }, zoomScale: 1.14, cameraShakeIntensity: 0.006 },
  smilo: { ...DEFAULT_ULTIMATE_PRESENTATION, enterFrom: "right", artworkScale: 1.06, cutInHoldMs: 390, zoomScale: 1.24, zoomMs: 115, cameraShakeIntensity: 0.011 },
  quetz: { ...DEFAULT_ULTIMATE_PRESENTATION, artworkScale: 0.94, artworkOrigin: { x: 650, y: 760 }, cutInHoldMs: 440, zoomScale: 1.16, cameraShakeIntensity: 0.008 },
  "husk-raptor": { ...DEFAULT_ULTIMATE_PRESENTATION, enterFrom: "right", cutInHoldMs: 380, zoomScale: 1.2, zoomMs: 110, cameraShakeIntensity: 0.008 },
