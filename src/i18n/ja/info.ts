...
export const INFO_JA = {
  ...
  "info.summon.title": "召喚獣",
  "info.summon.owner": "{owner}の召喚獣",
  "info.summon.growth": "成長の基準",
  "info.summon.growthSource": "{owner}の{stat}",
  "info.summon.growth.offense": "攻撃・速度",
  "info.summon.growth.body": "体力・防御・抵抗",
  "info.summon.growthBodySource": "{owner}の{atk}＋{ap}",
  "info.summon.resummon": "再召喚",
  "info.summon.resummonValue": "{seconds}秒",
  "info.summon.resummonHp": "体力{percent}%",
  "info.summon.resummonNone": "なし",
