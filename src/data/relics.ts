...
export const RELICS: RelicDef[] = [
  ...
  {
    /**
     * **새싹 레이티아.** 치즈케이크 대작전에 떼로 몰려오는 다섯 자매 중 하나다.
     *
  ...
  {
    /**
     * **물방울 레이티아.** 치즈케이크 대작전에 떼로 몰려오는 다섯 자매 중 하나다.
     *
     * 다섯은 한배에서 난 같은 몸이라 능력치도 스킬도 같고, **갈리는 것은 속성과 걸음걸이
     * 뿐이다** — 공속·이속만 개체마다 다르게 섞는다는 규칙 그대로다. 그래서 이 던전에서
     * 고를 것은 "무엇을 데려갈까"가 아니라 "어느 색에 강한 편성인가"가 된다.
  ...
  {
    /**
     * **잉걸 레이티아.** 치즈케이크 대작전에 떼로 몰려오는 다섯 자매 중 하나다.
     *
     * 다섯은 한배에서 난 같은 몸이라 능력치도 스킬도 같고, **갈리는 것은 속성과 걸음걸이
     * 뿐이다** — 공속·이속만 개체마다 다르게 섞는다는 규칙 그대로다. 그래서 이 던전에서
     * 고를 것은 "무엇을 데려갈까"가 아니라 "어느 색에 강한 편성인가"가 된다.
  ...
  {
    /**
     * **자갈 레이티아.** 치즈케이크 대작전에 떼로 몰려오는 다섯 자매 중 하나다.
     *
     * 다섯은 한배에서 난 같은 몸이라 능력치도 스킬도 같고, **갈리는 것은 속성과 걸음걸이
     * 뿐이다** — 공속·이속만 개체마다 다르게 섞는다는 규칙 그대로다. 그래서 이 던전에서
     * 고를 것은 "무엇을 데려갈까"가 아니라 "어느 색에 강한 편성인가"가 된다.
  ...
  {
    /**
     * **솔바람 레이티아.** 치즈케이크 대작전에 떼로 몰려오는 다섯 자매 중 하나다.
     *
     * 다섯은 한배에서 난 같은 몸이라 능력치도 스킬도 같고, **갈리는 것은 속성과 걸음걸이
     * 뿐이다** — 공속·이속만 개체마다 다르게 섞는다는 규칙 그대로다. 그래서 이 던전에서
     * 고를 것은 "무엇을 데려갈까"가 아니라 "어느 색에 강한 편성인가"가 된다.
