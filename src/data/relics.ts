...
export const RELICS: RelicDef[] = [
  ...
  },
  {
    ...
    observationProfile: {
      ...
      // E.C.는 티아라의 인간형 신체 나잇대이며, 원종 화석의 유체 단계와 독립된 값이다.
    ...
    unlockRecord: { status: "recorded", text: "복원 후 티아라는 물가만 보이면 먼저 뛰어들어 물살을 튀기고 도망치는 장난을 반복한다. 그러다 연구원이 다가오면 베일 자락으로 얼굴 절반을 가린 채 뒷걸음질 치면서도, 이름을 부르면 곧바로 곁으로 달려와 옷자락을 붙잡고 따라다닌다. 강가에서 “쁘띠 로그의 일”이라며 반짝이는 돌과 유리 조각을 한 움큼씩 주워 오는데, 쓸모가 없다는 말을 들은 날에는 꼬리날을 축 늘어뜨리고 한참 말이 없었다." },
    ...
    // 앞에 서서 물살을 받아 내는 아이라 폭주도 버티는 쪽으로 발현한다.
    ferocityTrait: { name: "안 아프거든!", effectId: "damageReduction", reductionPercent: 30 },
    passive: {
      id: "tiara-passive",
      name: "물살 방패",
      kind: "frontGuard",
